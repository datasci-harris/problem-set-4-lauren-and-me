...
**Question 1.2**
```{python}
pos2016 = pd.read_csv("C:\\Users\\mmmoh\\DPPS Python\\PSet\\problem-set-4-lauren-and-me\\pos2016.csv")
```
...
pos2017 = pd.read_csv("C:\\Users\\mmmoh\\DPPS Python\\PSet\\problem-set-4-lauren-and-me\\pos2017.csv")
...
pos2018 = pd.read_csv("C:\\Users\\mmmoh\\DPPS Python\\PSet\\problem-set-4-lauren-and-me\\pos2018.csv")
...
pos2019 = pd.read_csv("C:\\Users\\mmmoh\\DPPS Python\\PSet\\problem-set-4-lauren-and-me\\pos2019.csv")
...
```{python}
# Save full_unique_nums DataFrame to a CSV file
full_unique_nums.to_csv('full_unique_nums.csv', index=False)
```
...
'''
List of hospitals are there that fit this definition are 166
'''
2. 
```{python}
...
3. 
    a.
```{python}
active_hospitals_by_zip_year = full_unique_nums[(full_unique_nums['PGM_TRMNTN_CD'] == 0) & 
                                       (full_unique_nums['PRVDR_CTGRY_CD'] == 1) & 
                                       (full_unique_nums['PRVDR_CTGRY_SBTYP_CD'] == 1)]
...
census_data=gpd.read_file("C:\\Users\\mmmoh\\DPPS Python\\PSet\\problem-set-4-lauren-and-me\\gz_2010_us_860_00_500k.dbf")
```
